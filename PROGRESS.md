...
- [x] **`detect` — les cinq familles** *(2026-08-17)*, toutes déterministes, toutes génériques,
  ...
  - [ ] ⏭️ intégration des **échecs dbt test** du run comme anomalies déjà confirmées — **reste à
        faire** : c'est une entrée fournie par Airflow (4.5), pas une mesure que l'agent prend
